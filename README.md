...
Week UP 是我给自己做的一套计划与复盘工具，也还在持续迭代中。它不追求把生活塞进更多待办，而是想回答一件更实际的事：一个月想去哪里、这周要推进什么、今天到底做什么，以及做完以后留下了什么。
...
| 我的工作 | 产品定义、信息架构、交互与状态设计、全栈实现                           |
| 当前状态 | 自用中，持续迭代                                                       |

## The problem

我长期遇到的不是“没有地方记任务”，而是计划系统里的三个断点：
...
每个属性增长都来自已完成行动的奖励配置，并保留项目、时间与行动来源。这样属性面板表达的是“做过什么形成了增长”，而不是用游戏化数字制造虚假的进步感。
